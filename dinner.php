    ...
    <div class="container">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            ...
            <div class="col-12 col-md-12 col-lg-4">
              <a href="dinner.php"class="btn w-100 btn-outline-dark mb-3 active">Dinner</a>
        ...
        <div class="My-banner container col-lg-12" style="background-color: rgb(36, 97, 189); ">
          <p class="pStyle "style="  font-style: italic; color: rgb(6, 243, 45);">Healthy Dinner!!!Healthy Life</p>
          <p class="pStyle"style="  font-style: italic; color: rgb(6, 243, 45);">Only available from 8.00 PM to 3.00 AM </p>
        </div>
    ...
    <div class="title text-center mb-3">
        <hr style="border: 5px solid red; border-bottom: none;">
          <h3 class="font-weight-bolder"style="font-family: Cambria;font-style: italic;
               background-color: rgb(12, 1, 1); color: azure;">Dinner Menu</h3>
          <hr style="border: 5px solid red; border-bottom: none;">
        </div>
    <?php 
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-3">
          ...
          <?php echo '<img class="card-img-top"
            ...
            <div class="card-body">
              ...
              <button type="submit" name="Add_To_Cart" class="btn btn-dark mb-2">Add to My Order</button>
