...
<body class="" style="background-color: silver;">
  ...
  <header>
    ...
    <h1 class="mt-2 text-center text-light bg-dark" >Admin Control Panel</h1>
  ...
  <main>
    ...
    <main >
      ...
      <!-- menu ends here-->
      <!--....................................................-->
      <!-- admin control section starts here -->
      <div class="bg-dark text-light p-2">
        <!--control  menu header -->
       <div> <h1 class="text-center">Control Menu</h1></div>
       <!-- control menu items -->
       <!-- 1st row -->
       <div class="row text-center">
        <div class="col-lg-4 col-md-12 col-sm-12">
          <a  href="addNewProd.php" class="btn w-100 btn-success mb-3">Add new Dish</a>
        </div>
        <div class="col-lg-4 col-md-12 col-sm-12">
          <a  href="removeProd.php" class="btn w-100 btn-success mb-3">Remove Dish</a>
        </div>
        <div class="col-lg-4 col-md-12 col-sm-12">
          <a  href="updateProd1.php" class="btn w-100 btn-success mb-3">Update Dish Info</a>
        </div>
       </div>
       <!-- 2nd row -->
       <div class="row text-center">
        <div class="col-lg-4 col-md-12 col-sm-12">
          <a  href="addAdmin.php" class="btn w-100 btn-success mb-3">Add new admin</a>
        </div>
        <div class="col-lg-4 col-md-12 col-sm-12">
          <a  href="view-prod1.php" class="btn w-100 btn-success mb-3">View all dishes</a>
        </div>
        <div class="col-lg-4 col-md-12 col-sm-12">
          <a  href="CustOrder.php" class="btn w-100 btn-success mb-3">Customer Order</a>
        </div>
       </div>
       <!-- 3rd row -->
       <div class="row">
       <div class="col-lg-4 col-md-12 col-sm-12">
          <a  href="read-cust-msg.php" class="btn w-100 btn-success mb-3">Read Customer Message</a>
        </div>
       </div>

      </div>
      <!-- admin control section ends here -->
      <!--....................................................-->
    <!-- .............................................................................. -->
  </main>
  <!-- main ends here -->
