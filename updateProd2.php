...
<body style="background-color: rgb(172,172,172);">
    <div class="container bg-light">
        ...
        <header>
            ...
            <h1 class="mt-2 text-center text-light bg-dark">Update Dish Info Panel</h1>
 ...
 <div class="mymenu mt-2 mb-3" >
        <div class="bg-light">
         ...
         <!-- menu ends here-->
     <!-- .......................................................................... -->
        <!-- add new products section starts here -->
        <div>
            <!-- title is here -->
            <div>
                <hr style="border: 5px solid black; border-bottom: none;">
                <h1 style="text-align: center;">Update Dish information</h1>
                <hr style="border: 5px solid black; border-bottom: none;">
            </div>
            <!-- form is here -->
            <div class="row">
                ...
                <?php
                    ...
                    $sql="select * from {$category} where prod_id={$id}";
                ...
                ?>
                    <form class="" action="save-update.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="category" aria-label="Default select example">
                                ...
                                <?php
                                  ...
                                  $sql1= "select * from prod_category";
                                  ...
                                  $result1= mysqli_query($conn,$sql1)  or die("Query failed.");
                                    ...
                                    if(mysqli_num_rows($result1)>0){
                                      ...
                                      while($row1= mysqli_fetch_assoc($result1)){
                                          if($category==$row1['category_name']){
                                              $selected= "selected";

                                          }else{
                                            $selected= "";
                                          }
                                          echo " <option {$selected} value='{$row1['category_name']}'>{$row1['category_name']}</option>";
                                      }
                                    }
                                ?>
                              </select>
                            ...
                            <input type="number" name="id"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['prod_id']; ?>">
                        <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Dish Name:</label>
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['prod_name'];?>">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Dish Price:</label>
                            <input type="number" class="form-control"  name="price"id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['prod_price'];?>" >
                          </div>
                          <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Dish Unit:</label>
                            <input type="text" class="form-control" name="unit" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['prod_unit'];?>" >
                          </div>
                          <div class="mb-3">
                            <label for="" class="form-label">Dish Image:</label>
                            <input class="form-control" name="new-image"type="file" id="formFile" >
                            <img src="images/<?php echo $row['prod_img']; ?>" height="150px">
                            <input type="hidden" name="old-image"type="file" value="<?php echo $row['prod_img'];?>">

                          </div>
                        <div class="text-center">
                          <button type="submit" class="btn btn-danger">Update Dish Info</button>
                        </div>
                        </form>
                        <?php 
                                 }   
