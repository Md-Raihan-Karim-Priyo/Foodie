    ...
    <div class="container">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            ...
            <div class="col-12 col-md-12 col-lg-4">
              <a href="sweets.php"class="btn w-100  btn-outline-secondary mb-3 active">Sweets</a>
        ...
        <div class="My-banner container col-lg-12" style="background-color: rgb(36, 97, 189); ">
          <p class="pStyle "style="  font-style: italic; color: rgb(6, 243, 45);">Healthy Sweets!!!Sweet Life</p>
          <p class="pStyle"style="  font-style: italic; color: rgb(6, 243, 45);">Always Available </p>
        </div>
    ...
    <div class="title text-center mb-3">
        <hr style="border: 5px solid red; border-bottom: none;">
          <h3 class="font-weight-bolder"style="font-family: Cambria;font-style: italic;
               background-color: rgb(12, 1, 1); color: azure;">Sweets Menu</h3>
          <hr style="border: 5px solid red; border-bottom: none;">
        </div>
    <?php 
