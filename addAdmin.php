...
<body style="background-color: rgb(172,172,172);">
    <div class="container bg-light">
        ...
        <header>
            ...
            <h1 class="mt-2 text-center text-light bg-dark">Add Admin panel</h1>
     ...
     <!-- .......................................................................... -->
        ...
        <div>
            ...
            <div>
                ...
                <h1 style="text-align: center;">Add a new admin</h1>
                <hr style="border: 5px solid black; border-bottom: none;">
            </div>
            <!-- form is here -->
            <div class="row">
                ...
                <div  class="col-lg-6"style="border: 4px solid black;padding: 10px; background-color: aqua;">
                    <form class="" action="save-admin.php" method="POST">
                        <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Admin Name:</label>
                        <input type="text" class="form-control" name="admin_name" id="exampleInputEmail1" aria-describedby="admin name" >
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Admin Email:</label>
                            <input type="email" class="form-control"  name="admin_email"id="exampleInputEmail1" aria-describedby="emailHelp"  >
                          </div>
                          <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Password:</label>
                            <input type="password" class="form-control" name="admin_password" id="exampleInputEmail1" aria-describedby="emailHelp" >
                          </div>
                        <div class="text-center">
                          <button type="submit" class="btn btn-danger">Add as admin</button>
                        </div>
                        </form>
