...
<body style="background-color: rgb(172,172,172);">
    <div class="container" style="background: #7dd3ed;">
        ...
        <header>
            ...
            <h1 class="mt-2 text-center text-light bg-dark">Add Dish panel</h1>
        ...
        <div>
            ...
            <div class="row">
                ...
                <div  class="col-lg-6"style="border: 4px solid black;padding: 10px; background-color: aqua;">
                    <form class="form-group" action="save-prod.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Dish category:</label>
                            <select class="form-select" name="prod_category"aria-label="Default select example">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="prod_price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                          </div>
                          <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Unit:</label>
                            <input type="text" name="prod_unit" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                          </div>
                          <div class="mb-3">
                            <label for="formFile" class="form-label">Add Dish Image:</label>
                            <input class="form-control" type="file" name="fileToUpload" id="formFile" required>
                          </div>
                        <div class="text-center"><button type="submit" class="btn btn-danger">Add Dish</button></div>
                      </form>
